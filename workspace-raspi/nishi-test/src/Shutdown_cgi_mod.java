 ...
 *
 */
public class Shutdown_cgi_mod extends userCgiMod{
	/**
	 * 
	 */
	private String yid="raspi";
	private String ypass="raspi";
	public Shutdown_cgi_mod() {
	...
	public void start() {
		...
		System.out.println("Shutdown_cgi_mod::start() : #1 ");
		...
		System.out.println("Shutdown_cgi_mod::start() : #2 begin="+begin);
		if(begin == null || begin.equals("1") == false){
			System.out.println("Shutdown_cgi_mod::start() : #3 ");
			...
			System.out.println("Shutdown_cgi_mod::start() : #3 yid="+yid+",ypass="+ypass);
			if(this.yid.equals(yid) == false || this.ypass.equals(ypass) == false){
	...
	private void shutdown_exec(){
		System.out.println("Shutdown_cgi_mod::shutdown_exec() : #1 passed !");
		...
		+"<title>Shutdown_cgi_mod.class</title>\n"
...
+"//-->\n"
+"</script>\n"
+"<form method=\"POST\" action=\"/class-mod/Shutdown_cgi_mod\" onsubmit=\"return FrontPage_Form1_Validator(this)\" name=\"FrontPage_Form1\">\n"
