...
public class TempSensor2_cgi_mod extends userCgiMod2{

	public TempSensor2_cgi_mod() {
	...
	public void start() {
		...
		System.out.println("TempSensor2_cgi_mod::start() : #1 <br />");
		...
		ht_print("<title>TempSensor2_cgi_mod.class</title>\n");
		...
		ht_print("</head>\n");
		ht_print("<body>\n");
		ht_print("/class-mod/TempSensor2_cgi_mod を実行しています。<br />\n");
		ht_print("<hr />\n");
		check_temp();
		ht_print("<hr />\n");
		ht_print("</body>\n");
